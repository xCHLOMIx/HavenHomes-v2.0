...
const Navbar = () => {
    ...
    return (
        <div className='flex fixed top-8 z-10 max-sm:flex-col max-sm:gap-3 justify-between items-center w-full px-8 mx-auto'>
            <div className='bg-white/30 backdrop-blur-xs max-md:bg-white/60 border flex items-center gap-3 border-white/30 rounded-full w-max pr-5 pl-2 py-2'>
            ...
            <div className='flex bg-white/24 border-white/30 border max-md:text-black backdrop-blur-xs gap-2 p-1.5 rounded-full'>
                {links.map((link) => (
